...
class ArrayFieldListFilter(SimpleListFilter):
    ...
    def lookups(self, request, model_admin):
        ...
        queryset_values = model_admin.model.objects.values_list(self.parameter_name, flat=True)
        values = []
    ...
    def get_lookup_next(self, filter_params: dict, lookup: str):
        ...
        lookup_next: Union[List, str, None] = filter_params.get(parameter_name) or []
        if lookup_next:
            lookup_next = (
                lookup_next[0].split(",")
